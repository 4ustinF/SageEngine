							 ...
							 btVector3 *witness)
{
	...
	if ((btFuzzyZero(static_cast<btScalar>(s)) || s > 0.) && (ccdEq(static_cast<btScalar>(s), static_cast<btScalar>(1)) || s < static_cast<btScalar>(1)) && (btFuzzyZero(static_cast<btScalar>(t)) 
		|| t > 0.) && (ccdEq(static_cast<btScalar>(t), static_cast<btScalar>(1)) || t < 1.) && (ccdEq(static_cast<btScalar>(t + s), static_cast<btScalar>(1)) || t + s < 1.))
	{
		if (witness)
		{
			btVec3Scale(&d1, s);
