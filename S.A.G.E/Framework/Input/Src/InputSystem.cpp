...
int& InputSystem::GetMouseScreenX()
{
	return mCurrMouseX;
}

int& InputSystem::GetMouseScreenY()
{
	return mCurrMouseY;
}
...
int& InputSystem::GetPrevMouseScreenX()
{
	return mPrevMouseX;
}

int& InputSystem::GetPrevMouseScreenY()
{
	return mPrevMouseY;
}

int InputSystem::GetPrevMouseScreenX() const
{
	return mPrevMouseX;
}

int InputSystem::GetPrevMouseScreenY() const
{
	return mPrevMouseY;
}
