...
{
	m_contactBreakingThreshold = static_cast<btScalar>(manifoldDataPtr->m_contactBreakingThreshold);
	m_contactProcessingThreshold = static_cast<btScalar>(manifoldDataPtr->m_contactProcessingThreshold);
	...
	for (int i = 0; i < this->getNumContacts(); i++)
	{
		...
		pt.m_appliedImpulse = static_cast<btScalar>(manifoldDataPtr->m_pointCacheAppliedImpulse[i]);
		pt.m_prevRHS = static_cast<btScalar>(manifoldDataPtr->m_pointCachePrevRHS[i]);
		pt.m_appliedImpulseLateral1 = static_cast<btScalar>(manifoldDataPtr->m_pointCacheAppliedImpulseLateral1[i]);
		pt.m_appliedImpulseLateral2 = static_cast<btScalar>(manifoldDataPtr->m_pointCacheAppliedImpulseLateral2[i]);
		...
		pt.m_distance1 = static_cast<btScalar>(manifoldDataPtr->m_pointCacheDistance[i]);
		pt.m_combinedContactDamping1 = static_cast<btScalar>(manifoldDataPtr->m_pointCacheCombinedContactDamping1[i]);
		pt.m_combinedContactStiffness1 = static_cast<btScalar>(manifoldDataPtr->m_pointCacheCombinedContactStiffness1[i]);
		pt.m_lifeTime = manifoldDataPtr->m_pointCacheLifeTime[i];
		pt.m_frictionCFM = static_cast<btScalar>(manifoldDataPtr->m_pointCacheFrictionCFM[i]);
		pt.m_contactERP = static_cast<btScalar>(manifoldDataPtr->m_pointCacheContactERP[i]);
		pt.m_contactCFM = static_cast<btScalar>(manifoldDataPtr->m_pointCacheContactCFM[i]);
		...
		pt.m_combinedFriction = static_cast<btScalar>(manifoldDataPtr->m_pointCacheCombinedFriction[i]);
		...
		pt.m_combinedRollingFriction = static_cast<btScalar>(manifoldDataPtr->m_pointCacheCombinedRollingFriction[i]);
		pt.m_combinedSpinningFriction = static_cast<btScalar>(manifoldDataPtr->m_pointCacheCombinedSpinningFriction[i]);
		pt.m_combinedRestitution = static_cast<btScalar>(manifoldDataPtr->m_pointCacheCombinedRestitution[i]);
		pt.m_contactMotion1 = static_cast<btScalar>(manifoldDataPtr->m_pointCacheContactMotion1[i]);
		pt.m_contactMotion2 = static_cast<btScalar>(manifoldDataPtr->m_pointCacheContactMotion2[i]);
	}
}
