...
{
	return static_cast<int>(m_data->m_bodyBufferGPU->size());
}
...
{
	return static_cast<int>(m_data->m_inertiaBufferGPU->size());
}
...
{
	return static_cast<int>(m_data->m_collidablesGPU->size());
}

int b3GpuNarrowPhase::getNumContactsGpu() const
{
	return static_cast<int>(m_data->m_pBufContactBuffersGPU[m_data->m_currentContactBuffer]->size());
}
