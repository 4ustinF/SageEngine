...
static SIMD_FORCE_INLINE void getBernsteinCoeff(const btSoftBody::Face* face, const btSoftBody::Node* node, const btScalar& dt, btScalar& k0, btScalar& k1, btScalar& k2, btScalar& k3)
{
	...
	k0 = static_cast<btScalar>((p0ma0).dot(n0) * 3.0);
	k1 = (p0ma0).dot(n_hat) + (p1ma1).dot(n0);
	k2 = (p1ma1).dot(n_hat) + (p0ma0).dot(n1);
	k3 = static_cast<btScalar>((p1ma1).dot(n1) * 3.0);
}
...
{
	btScalar Yu0 = static_cast<btScalar>(k0 * (1.0 - u0) * (1.0 - u0) * (1.0 - u0) + 3.0 * k1 * u0 * (1.0 - u0) * (1.0 - u0) + 3.0 * k2 * u0 * u0 * (1.0 - u0) + k3 * u0 * u0 * u0);  // Y(u0)
	btScalar Yv0 = static_cast<btScalar>(k0 * (1.0 - v0) * (1.0 - v0) * (1.0 - v0) + 3.0 * k1 * v0 * (1.0 - v0) * (1.0 - v0) + 3.0 * k2 * v0 * v0 * (1.0 - v0) + k3 * v0 * v0 * v0);  // Y(v0)
...
static SIMD_FORCE_INLINE bool signDetermination2Internal(const btScalar& k0, const btScalar& k1, const btScalar& k2, const btScalar& k3, const btScalar& j0, const btScalar& j1, const btScalar& j2, const btScalar& u0, const btScalar& u1, const btScalar& v0, const btScalar& v1)
{
	...
	{
		btScalar Yp_u0 = static_cast<btScalar>(j0 * (1.0 - u0) * (1.0 - u0) + 2.0 * j1 * (1.0 - u0) * u0 + j2 * u0 * u0);
	...
	btScalar Yv0 = static_cast<btScalar>(k0 * (1.0 - v0) * (1.0 - v0) * (1.0 - v0) + 3.0 * k1 * v0 * (1.0 - v0) * (1.0 - v0) + 3.0 * k2 * v0 * v0 * (1.0 - v0) + k3 * v0 * v0 * v0);  // Y(uv0)
	sign_Ytp = (v0 > v1) ? Yv0 : -Yv0;
	btScalar K1, K2;
	if (diffSign(sign_Ytp, k0))
	{
	...
	{
		btScalar Yp_v0 = static_cast<btScalar>(j0 * (1.0 - v0) * (1.0 - v0) + 2.0 * j1 * (1.0 - v0) * v0 + j2 * v0 * v0);
...
static SIMD_FORCE_INLINE bool signDetermination1(const btScalar& k0, const btScalar& k1, const btScalar& k2, const btScalar& k3, const btSoftBody::Face* face, const btSoftBody::Node* node, const btScalar& dt)
{
	...
	if (nearZero(static_cast<btScalar>(j0 + j2 - j1 * 2.0)))
	{
		btScalar lt0, lt1;
...
{
	k10 = static_cast<btScalar>(k0 * (1.0 - t0) + k1 * t0);
	btScalar k11 = static_cast<btScalar>(k1 * (1.0 - t0) + k2 * t0);
	k12 = static_cast<btScalar>(k2 * (1.0 - t0) + k3 * t0);
	k20 = static_cast<btScalar>(k10 * (1.0 - t0) + k11 * t0);
	k21 = static_cast<btScalar>(k11 * (1.0 - t0) + k12 * t0);
	k30 = static_cast<btScalar>(k20 * (1.0 - t0) + k21 * t0);
}
